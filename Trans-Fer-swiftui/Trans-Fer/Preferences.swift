...
struct PreferencesView : View {
  ...
  @State private var mWindow : NSWindow?
  ...
  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    ...
    var body: some View {
      VStack (spacing: 12) {
        ...
        Button (action: { self.definirCheminApplicationPiccolo (self.mWindow) }) {
  ...
  func definirCheminApplicationPiccolo (_ inWindow : NSWindow?) {
